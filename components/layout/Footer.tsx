        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/?category=jewelery" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  Joyería
                </Link>
              </li>
              <li>
                <Link href="/?category=men's clothing" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  Moda Hombre
                </Link>
              </li>
              <li>
                <Link href="/?category=women's clothing" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  Moda Mujer
                </Link>
              </li>
            </ul>
